...
import com.gmyboy.codelab.accesibility.AutoClickAccessibilityService;

/**
 * 辅助功能相关检查的帮助类
 */
public class AccessibilityUtil {
    private static final String ACCESSIBILITY_SERVICE_PATH = AutoClickAccessibilityService.class.getCanonicalName();
    /**
     * 判断是否有辅助功能权限
     *
     * @param context
